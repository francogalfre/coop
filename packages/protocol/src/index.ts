...
export { capabilities, type Capabilities } from "./shared/capabilities.js";
export { HARNESS_COMMANDS, harnessCommand, type HarnessCommand } from "./shared/commands.js";
export { diffHunk, type DiffHunk } from "./shared/diff.js";
