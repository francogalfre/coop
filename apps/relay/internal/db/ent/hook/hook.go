...
// The CliCredentialFunc type is an adapter to allow the use of ordinary
// function as CliCredential mutator.
type CliCredentialFunc func(context.Context, *ent.CliCredentialMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CliCredentialFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CliCredentialMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CliCredentialMutation", m)
}
...
// The ProjectInviteFunc type is an adapter to allow the use of ordinary
// function as ProjectInvite mutator.
type ProjectInviteFunc func(context.Context, *ent.ProjectInviteMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProjectInviteFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProjectInviteMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProjectInviteMutation", m)
}
