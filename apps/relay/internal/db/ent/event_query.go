...
func (_q *EventQuery) QuerySession() *AgentSessionQuery {
...
func (_q *EventQuery) WithSession(opts ...func(*AgentSessionQuery)) *EventQuery {
	query := (&AgentSessionClient{config: _q.config}).Query()
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withSession; query != nil {
		if err := _q.loadSession(ctx, query, nodes, nil,
			func(n *Event, e *AgentSession) { n.Edges.Session = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventQuery) loadSession(ctx context.Context, query *AgentSessionQuery, nodes []*Event, init func(*Event), assign func(*Event, *AgentSession)) error {
