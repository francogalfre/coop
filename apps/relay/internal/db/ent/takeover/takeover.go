...
const (
	// Label holds the string label denoting the takeover type in the database.
	Label = "takeover"
	...
	EdgeSession = "session"
	// Table holds the table name of the takeover in the database.
	Table = "takeovers"
	// SessionTable is the table that holds the session relation/edge.
	SessionTable = "takeovers"
	...
	SessionColumn = "agent_session_takeover"
)

// Columns holds all SQL columns for takeover fields.
var Columns = []string{
	FieldID,
	FieldActorID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "takeovers"
...
// OrderOption defines the ordering options for the Takeover queries.
