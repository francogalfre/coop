...
const markDataUrl = `data:image/png;base64,${readFileSync(join(process.cwd(), "public/coop-mark.png")).toString("base64")}`;
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 26 }}>
            <img src={markDataUrl} width={92} height={92} alt="" style={{ display: "flex" }} />
